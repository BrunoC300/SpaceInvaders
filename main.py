...
def main():
    ...
    def redraw_window():
        WIN.blit(BG, (0, 0))  # ADICIONAMOS UMA IMAGEM DE FUNDO QUE COMEÇA NO CANTO SUPERIOR ESQUERDO (0,0)
    ...
    while run:
        ...
        for enemy in enemies[:]:  # [:] faz uma copia da lista
            ...
            if random.randrange(0, 2 * FPS) == 1:  # A cada segunda á probabilidade de 50% do inmigo disparar
                enemy.shoot()
            ...
            if collide(enemy, player):
                ...
                enemies.remove(enemy)  # Esse inimigo é removido da lista
...
def main_menu():
    ...
    while run:
        WIN.blit(BG, (0,0))
        title_label = title_font.render("Pressione o rato para começar...",1 ,(255,255,255))
